...
describe('Transaction', () => {
  ...
  describe('input', () => {
    ...
    /** con la publickey puedo verificar que sea valida la transaction */
  ...
  describe('update()', () => {
    ...
    describe('and the amount is valid', () => {
      ...
      it('re-signs the transaction', () => {
        ...
        console.log('Signature new', transaction.input.signature);
        console.log('Signature old', originalSignature);
